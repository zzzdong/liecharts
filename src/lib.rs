...
pub use option::{
    AnimationOption, AreaStyleOption, AxisLabelOption, AxisLineOption, AxisOption, AxisPointerOption,
    ...
    GridOption, ItemStyleOption, LabelAlign, LabelLineOption, LabelOption, LabelPosition,
    LabelVerticalAlign, LegendOption, LineSeriesOption, LineStyleOption, LineType, MarkAreaOption,
    MarkLineOption, MarkPointOption, NameLocation, OneOrMany, Orient, PieSeriesOption, PolarBarSeriesOption,
    ...
    ScatterSeriesOption, SeriesEncodeOption, SeriesOption, ShadowStyleOption, SplitAreaOption, SplitLineOption, SymbolType,
    TableBodyOption, TableCellStyleOption, TableHeaderOption, TableRowStyleOption,
    TableSeriesOption, TextAlignOption, TextStyleOption, TitleOption, TooltipOption, TooltipTrigger,
    VisualMapOption, VisualMapType,
};
pub use pipeline::{

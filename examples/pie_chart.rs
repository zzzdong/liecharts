...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let option = LieChartOption {
        title: Some(liecharts::TitleOption {
            text: Some("访问来源".to_string()),
            subtext: Some("纯属虚构".to_string()),
            ..Default::default()
        }),
    ...
    chart.render_to_image("pie_chart.png")?;
    chart.render_to_svg("pie_chart.svg")?;
    println!("饼图已保存到 pie_chart.png 和 pie_chart.svg");

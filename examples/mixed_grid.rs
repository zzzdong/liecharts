...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    Chart::new(1000, 900)
        ...
        .sub_grid(
            ...
            |g| {
                g.x_axis(Axis::category().data(["1月", "2月", "3月", "4月", "5月", "6月"]))
                    .y_axis(Axis::value())
                    .add_layer(
                        Bar::new()
                            .data(dataframe!(
        ...
        .sub_grid(
            Grid::new()
                ...
                .bottom(Position::pct(52.0)),
            |g| {
                g.x_axis(Axis::category().data(["周一", "周二", "周三", "周四", "周五", "周六"]))
                    .y_axis(Axis::value())
                    .add_layer(
                        Line::new()
                            .data(dataframe!(
        ...
        .sub_grid(
            ...
            |g| {
                g.x_axis(Axis::category().data(["产品A", "产品B", "产品C", "产品D", "产品E"]))
                    .y_axis(Axis::value())
                    .add_layer(
                        Bar::new()
                            .data(dataframe!(
        ...
        .sub_grid(
            Grid::new()
                ...
                .bottom(Position::pct(3.0)),
            |g| {
                g.x_axis(Axis::category().data(["Q1", "Q2", "Q3", "Q4"]))
                    .y_axis(Axis::value())
                    .add_layer(
                        Line::new()
                            .data(dataframe!(
